...
const Select = (props) => {
  ...
  return (
    <div
      ref={ref}
      className={`${className} flex justify-between z-10 text-black dark:text-gray-400 rounded-lg shadow w-44 dark:bg-transparent border border-dark-gray relative items-center cursor-pointer select-none`}
      //   onClick={() => {
      //     setExpand(true)
      //   }}
    >
