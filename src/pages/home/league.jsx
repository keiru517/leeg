                  ...
                  <div className="flex flex-col border border-dark-gray rounded p-7">
                    <div>
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <p className="dark:text-white text-black text- sm:text-sm">
                            League Name
                          </p>
                          <Input
                            className="rounded-default flex-grow text-sm w-32 h-8"
                      ...
                      <div className="mb-4">
                        ...
                        <textarea
                          id="message"
                          rows="6"
                          className="block p-2.5 w-full text-sm text-gray-900 rounded-lg border border-charcoal focus:ring-blue-500 focus:border-blue-500 dark:bg-transparent dark:border-charcoal dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 resize-none outline-none"
                      ...
                      <div className="mb-6 grid grid-cols-2 gap-2">
                        ...
                        <span>
                          <p className="dark:text-white text-black text-sm">End Date</p>
                          <DatePicker
                            className="text-xs h-12 rounded px-3 py-2 w-full"
                            date={leagueEndDate}
                        ...
                        <div className="grid grid-cols-2 gap-2 mt-3">
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              navigator.clipboard.writeText(`${window.location}`.replace('league', leagueName).replace('tab=7', 'tab=0'))
                            }}
